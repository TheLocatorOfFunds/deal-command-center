-- Add a 0.25h floor so accidental same-minute clock in/out (test entries,
-- mis-clicks) don't surface in payroll reminders. Only the HAVING clause
-- changed (> 0  →  >= 0.25); full function replace for clarity.
